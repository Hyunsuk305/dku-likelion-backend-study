...
public class HomeController {
    ...
    public List<Post> getPosts(){
        List<Post> posts = new ArrayList<>(){{
            ...
            add(new Post(1L, LocalDateTime.now(), LocalDateTime.now(), "제목 2", "내용 2"));
            add(new Post(1L, LocalDateTime.now(), LocalDateTime.now(), "제목 3", "내용 3"));
            add(new Post(1L, LocalDateTime.now(), LocalDateTime.now(), "제목 4", "내용 4"));
            add(new Post(1L, LocalDateTime.now(), LocalDateTime.now(), "제목 5", "내용 5"));
        }};
        return posts;
    }
